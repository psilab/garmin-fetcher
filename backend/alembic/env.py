...
from app import models  # noqa: F401 - registers Workout on Base.metadata
...
# Read the DB URL from the DATABASE_URL env var if set (falls back to
# alembic.ini's sqlalchemy.url, e.g. when a caller — like a test — has
# already called config.set_main_option("sqlalchemy.url", ...)).
